...
parser.add_argument("-s", help="Path of the folder in which the results"
...
parser.add_argument("-p", help="Path of the folder in which the parameter"
...
parser.add_argument("-o", help="Path of the folder in which the files for"
                    " openPMD evaluation can be found.",
                    dest="openPMD",
                    type=str,
                    const=None,
                    nargs="?",
...
parser.add_argument("-j", help="Path of the folder to the json files"
                    " if used.",
                    dest="json",
                    type=str,
                    const=None,
